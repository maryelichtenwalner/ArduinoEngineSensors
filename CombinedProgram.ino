...
void loop() {
  ...
  float calibration = 0.135;                                                            // Calibrate here. Adjust so that ambient pressure is correct.
  float pressure_pascal1 = (3.0*(voltage1-calibration))*1000000.0; 
  ...
  float calibration = 0.14;                                                             // Calibrate here. Adjust so that ambient pressure is correct.
  float pressure_pascal2 = (3.0*(voltage2-calibration))*1000000.0;
